...
export const DEADSTOCK_ACTIONS = [
  ...
  // สองตัวล่างนี้แปลว่า "ไม่ได้ค้างจริง" — ของไม่ได้อยู่ในคลังแล้ว แต่ระบบยังนับว่าค้างเพราะเอกสารไม่ครบ
  // (เพิ่ม 27/08/2026 ตามที่ผู้ใช้สั่ง) ต่างจากสี่ตัวบนที่เป็นการตัดสินใจว่าจะทำอะไรกับของที่ยังอยู่จริง
  { key: "used", label: "ใช้แล้ว", hint: "ของถูกเอาไปใช้แล้วจริง แต่ระบบยังขึ้นว่าค้างอยู่" },
  { key: "no_wd", label: "ไม่มี WD", hint: "เอาของไปใช้แล้วแต่ไม่ได้เปิดใบเบิก (WD) ยอดในระบบจึงไม่ลดลง" },
] as const
