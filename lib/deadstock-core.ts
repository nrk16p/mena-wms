...
export const DEADSTOCK_ACTIONS = [
  // ตัวเดียวในลิสต์ที่แปลว่า "ไม่มีปัญหา" — ของยังได้ใช้ตามแผนเดิม แค่ยังไม่ถึงคิวรถเข้า
  // อยู่บนสุดเพราะเป็นคำตอบที่เจอบ่อยสุด · ใช้ศัพท์ชุดเดียวกับสถานะ "ของถึง-รอลงคัน"
  // ของโมดูลอะไหล่ลงคัน (lib/repair-external.ts) เพื่อให้คนอ่านข้ามหน้าแล้วเข้าใจตรงกัน
  { key: "await_install", label: "รอลงคัน", hint: "ของมาถึงแล้ว รอคิวเอาลงคันตามแผนเดิม — ยังได้ใช้ตามวัตถุประสงค์เดิม" },
