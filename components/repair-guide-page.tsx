...
const COLORS: Record<string, string> = {
  "แจ้งซ่อมอู่นอก": "#9ca3af", "รถเข้าซ่อมอู่นอก": "#3b82f6", "รอใบเสนอราคา": "#06b6d4",
  "จัดทำใบเสนอราคา": "#0891b2", "รอ PR อนุมัติ": "#f59e0b", "ชะลองานซ่อม": "#64748b",
      ...
      <div className="space-y-4">
        ...
        <Section icon={Timer} title="ขั้นตอนงาน (Workflow) & เกณฑ์ค้างงาน (SLA)">
          ...
          <ul className="mt-1 ml-1 space-y-1">
            ...
            <li className="flex items-start gap-2"><span className="mt-0.5 shrink-0">🛡️</span><span><b>ปิดงานได้ 3 แบบ</b> — <b>"รถเสร็จ"</b> = ซ่อมโดยจ่ายเงินตามปกติ ต้องมีเอกสารครบถึง<b>รหัส PR</b> · <b>"รถเสร็จ(เคลมอู่)"</b> = อู่รับผิดชอบค่าซ่อมเอง (งานในประกันของอู่) <b>ไม่มี PR/PO</b> ปิดได้เลยจากสถานะไหนก็ได้ ขอแค่<b>วันที่ซ่อมเสร็จ</b> · <b>"ชะลองานซ่อม"</b> = ยังไม่ซ่อม พักไว้ก่อน ไม่ต้องกรอกอะไรเพิ่ม (เหตุผลอยู่ในข้อความอัพเดทงาน) · ทั้งสามแบบย้ายไปหน้า "งานเสร็จ" หลุดจากรายการตาม PR และปลดล็อกให้เปิดใบใหม่ของรถคันนั้นได้</span></li>
            ...
            <li className="flex items-start gap-2"><span className="mt-0.5 shrink-0">🔒</span><span><b>ปิดงานแล้วล็อก</b> — "รถเสร็จ" / "รถเสร็จ(เคลมอู่)" / "ชะลองานซ่อม" / "ลงคันเสร็จ" เปลี่ยน/ย้อนสถานะไม่ได้อีก (แก้ฟิลด์อื่นได้ · จะกลับมาซ่อมให้เปิดใบใหม่)</span></li>
          </ul>
        </Section>
